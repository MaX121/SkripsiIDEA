...
public class DTNHost implements Comparable<DTNHost> {
	...
	private Map<String, Double> tombstone;
	...
	public DTNHost(List<MessageListener> msgLs,
		...
		this.tombstone = new TreeMap<String, Double>();
	...
	// adding a new host and latest message creation time
	public void addMessageToTombstone(Message m) { tombstone.put(m.getFrom().toString(), m.getCreationTime()); }
	public void defaultTombstoneSettings(Message m) { tombstone.put(m.getFrom().toString(), 0.0); }
	public Map <String, Double> getTombstoneList() { return tombstone; }
